...
public class EESecurityTest {
    ...
    public void testCustomAuthenticationMechanism() throws IOException {
        ...
        String response2 = Request.Get("http://localhost:8080/security?name=thorntail1&password=secret2")
                .execute().returnContent().asString().trim();
        assertThat(response2).isEqualTo("thorntail1,role1:true,role2:false");
    }
}
